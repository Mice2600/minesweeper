    ...
    switch (msg) {
        ...
        if (snap != null && snap.config.width == config.width &&
          ...
          state = state.copyWith(
            ...
            snapshot: GameSnapshot(
              ...
              minePositions: snap.minePositions,
              losingPlayerId: snap.losingPlayerId,
              stats: snap.stats,
            ),
      ...
      case SGameStarted(:final config):
        ...
        state = state.copyWith(
          config: config,
          snapshot:
              _emptySnapshot(config, hostId, players, GameStatus.playing),
      ...
      case SCursor(:final playerId, :final nx, :final ny):
        ...
        final newCursors = Map<String, ({double nx, double ny})>.from(
            snap.cursors);
